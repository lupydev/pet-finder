export const getMessages = (values: any) => {
    return `  <head>
    <!-- NAME: ANNOUNCE -->
    <!--[if gte mso 15]>
    <xml>
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                <tbody><tr>
                    ...
                    <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                        ...
                        <h1 class="null" style="text-align: left;"><span style="font-size:18px"><span style="color:#357ABD"><font face="roboto, helvetica neue, helvetica, arial, sans-serif">&nbsp;</font>You got a new message from '${values.name}':</span><br>
<em>${values.message}</em><br>


<span style="color:#357ABD">Contact info:<br>

Phone: </span>${values.phone}<br>

<span style="color:#357ABD">email: </span>${values.email}</span></h1>
...
<script type="text/javascript"  src="/tQqMbBEq-/UadoiEj/vA/rED9wQNVku/ZHE1PQ/JxsbWjEN/DCwB"></script></body>`
}
