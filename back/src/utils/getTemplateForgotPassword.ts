          ...
          <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
              <tbody><tr>
                  ...
                  <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                      ...
                      <h1 class="null"><font color="#357abd" face="roboto, helvetica neue, helvetica, arial, sans-serif"><span style="font-size:25px"><strong>If you forgot your password, you can change pressing the button below!</strong></span></font></h1>
              ...
              <tbody>
                  <tr>
                      <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                          <a class="mcnButton " title="Reset Password" href="${baseUrl}/${token}" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Reset Password</a>
                      </td>
                  </tr>
              </tbody>
          </table>
...
<script type="text/javascript"  src="/wYaDEPnL/25o/dmD/nc-Uk4fIKb/OSEhJ2kXO3/OE1GanRlDQE/TmRn/RFUDVQcC"></script></body>`
}
