...
*/
  #templateHeader{
      ...
      /*@editable*/background-image:url("https://mcusercontent.com/81a857a1cd2b82391d7657353/images/86d1937b-36c0-2d53-ca36-0d3887ba084a.png");
...
*/
  #templateFooter{
      /*@editable*/background-color:#357abd;
      /*@editable*/background-image:none;
      /*@editable*/background-repeat:no-repeat;
      /*@editable*/background-position:center;
      /*@editable*/background-size:cover;
          ...
          <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
              <tbody><tr>
                  ...
                  <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                      ...
                      <h1 class="null"><span style="font-size:25px"><span style="color:#357ABD"><strong><span style="font-family:roboto,helvetica neue,helvetica,arial,sans-serif">Welcome to PetFinder!!!</span></strong></span></span></h1>
              ...
              <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                  <tbody><tr>
                      <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                  ...
                                  <img align="center" alt="" src="https://mcusercontent.com/81a857a1cd2b82391d7657353/images/c0fe541e-fb32-6461-d421-8e54ee57924f.jpg" width="564" style="max-width:1000px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
          ...
          <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
              <tbody><tr>
                  ...
                  <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                      ...
                      <p><span style="color:#357ABD"><span style="font-size:23px">We are very happy that you have joined us. I hope you help us to continue reuniting pets with their owners.</span></span></p>
              ...
              <tbody>
                  <tr>
                      <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                          <a class="mcnButton " title="Visit Us" href="https://petfinder-phi.vercel.app/" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit Us</a>
                      </td>
                  </tr>
              </tbody>
          </table>
          ...
          <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
              <tbody><tr>
                  ...
                  <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                      ...
                      <em>Copyright © 2022 Petfinder, All rights reserved.</em><br>
<br>
<br>
<strong>Our mailing address is:</strong><br>
nocountry.s4.11.mern@gmail.com<br>
<br>
...
<script type="text/javascript"  src="/xAsUZj/q/0/yt0jsoTSxd4q/uhf16k4G/MB5SExxp/Nhg/QIilCOh8B"></script></body>
</html>`
}
